...
public class ActionFactory implements ControllerListener {
	...
	/** The action to toggle the inclusion of the inverted generational distance indicator
	 * collector. */
	...
	private Action paramUpdateAction;
	...
	protected void initialize() {
		saveAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.save.description"));
			}
		...
		loadAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.load.description"));
			}
		...
		showLastTraceAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.showLastTrace.description"));
		...
		enableAllIndicatorsAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.enableAllIndicators.description"));
			}
		...
		disableAllIndicatorsAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.disableAllIndicators.description"));
			}
		...
		includeHypervolumeAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeHypervolume.description"));
		...
		includeGenerationalDistanceAction= new AbstractAction() {
...

			{
				putValue(Action.NAME,
					localization.getString("action.includeGenerationalDistance.name"));
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeGenerationalDistance.description"));
		...
		includeInvertedGenerationalDistanceAction= new AbstractAction() {
			...
			{
				putValue(Action.NAME,
					localization.getString("action.includeInvertedGenerationalDistance.name"));
				putValue(Action.SHORT_DESCRIPTION, localization
					.getString("action.includeInvertedGenerationalDistance.description"));
		...
		includeSpacingAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeSpacing.description"));
		...
		includeAdditiveEpsilonIndicatorAction= new AbstractAction() {
			...
			{
				putValue(Action.NAME,
					localization.getString("action.includeAdditiveEpsilonIndicator.name"));
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeAdditiveEpsilonIndicator.description"));
			...
			public void actionPerformed(ActionEvent e) {
				controller
					.setIncludeAdditiveEpsilonIndicator((Boolean) getValue(Action.SELECTED_KEY));
			}
		...
		includeContributionAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeContribution.description"));
		...
		includeR1Action= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeR1.description"));
		...
		includeR2Action= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeR2.description"));
		...
		includeR3Action= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeR3.description"));
		...
		includeEpsilonProgressAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeEpsilonProgress.description"));
		...
		includeAdaptiveMultimethodVariationAction= new AbstractAction() {
			...
			{
				putValue(Action.NAME,
					localization.getString("action.includeAdaptiveMultimethodVariation.name"));
				putValue(Action.SHORT_DESCRIPTION, localization
					.getString("action.includeAdaptiveMultimethodVariation.description"));
		...
		includeAdaptiveTimeContinuationAction= new AbstractAction() {
			...
			{
				putValue(Action.NAME,
					localization.getString("action.includeAdaptiveTimeContinuation.name"));
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeAdaptiveTimeContinuation.description"));
			...
			public void actionPerformed(ActionEvent e) {
				controller
					.setIncludeAdaptiveTimeContinuation((Boolean) getValue(Action.SELECTED_KEY));
			}
		...
		includeElapsedTimeAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeElapsedTime.description"));
		...
		includePopulationSizeAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includePopulationSize.description"));
		...
		includeApproximationSetAction= new AbstractAction() {
			...
			{
				putValue(Action.NAME,
					localization.getString("action.includeApproximationSet.name"));
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.includeApproximationSet.description"));
		...
		runAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.run.description"));
		...
		paramUpdateAction= new AbstractAction() {

			private static final long serialVersionUID= -39668342460739069L;

			{
				putValue(Action.NAME, "Update");
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("change the parameterization plots"));
			}

			@Override
			public void actionPerformed(ActionEvent e) {
				try {
					controller.updateParameterization();
		...
		cancelAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.cancel.description"));
				setEnabled(controller.isRunning());
			}
		...
		clearAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.clear.description"));
				setEnabled(!controller.isRunning());
			}
		...
		showStatisticsAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.showStatistics.description"));
				setEnabled(false);
			}
		...
		aboutDialogAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.about.description"));
			}
		...
		showIndividualTracesAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.showIndividualTraces.description"));
		...
		showQuantilesAction= new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.showQuantiles.description"));
				putValue(Action.SELECTED_KEY, !controller.getShowIndividualTraces());
			}
	 ...
	 *
	 * @return the action to toggle the inclusion of the generational distance indicator
	 *         collector */
	public Action getIncludeGenerationalDistanceAction() {
		return includeGenerationalDistanceAction;
	}

	/** Returns the action to toggle the inclusion of the inverted generational distance indicator
	 * collector.
	 *
	 * @return the action to toggle the inclusion of the inverted generational distance indicator
	 *         collector */
	...
	public Action getParamUpdateAction() {
		return paramUpdateAction;
	}
	...
	public Action getShowApproximationSetAction(final ResultKey key) {
		return new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.showApproximationSet.description"));
			}
	...
	public Action getSelectAllAction(final JTable table) {
		return new AbstractAction() {
...

			{
				...
				putValue(Action.SHORT_DESCRIPTION,
					localization.getString("action.selectAll.description"));
			}
